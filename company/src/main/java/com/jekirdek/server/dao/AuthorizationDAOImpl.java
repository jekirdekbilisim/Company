...
public class AuthorizationDAOImpl extends AbstractDAOImpl<String, UserRole> implements AuthorizationDAO {
	...
	@Override
	public List<ListItem> getAllCompany() throws Exception {
	...
	@Override
	public List<ListItem> getCompanyByUserOid(String userOid) throws Exception {
	...
	@Override
	public List<ListItem> getCompanyByUserTckn(String userTckn) throws Exception {
	...
	@Override
	public void deleteRoleByUserAndCompany(String userTckn, String companyOid) throws Exception {
		...
		if (result == null || result.size() != 1)
			throw new Exception("silme aşamasında 1 den fazla şirket bulundu, sadece 1 tane olmasi gerekli");
